 ...
 // Parallax background
   ...
   /*------------------------------------------
    ...
    $("#logOut").on("click", function (){
        $.ajax({
            url: "/hotelUser/logOut",
            data: {},
            type: "post",
            success: function (data){
                layer.msg('用户退出成功',{icon:1});
                $(".mini-cart-content").removeClass("mini-cart-content-toggle");

            },
            error: function (data){
                layer.msg("error失败！", {icon:2});
            }
        })
    });
    ...
    $("#register").on("click", function (){
        layer.open({
            ...
            title: "注册",
            area: ['350px','500px'],
            content: "/hotelUser/register_view"
        });
    });
    ...
    $(function () {
        $("#kaptcha").on('click', function () {
            $("#kaptcha").attr('src', '/index/kaptcha?' + Math.floor(Math.random() * 100)).fadeIn();
        });
